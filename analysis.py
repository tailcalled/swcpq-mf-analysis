...
plt.title("Concordance between masculinity-femininity in\nmen and women")
plt.xlabel("M-F according to male standards")
plt.ylabel("F-M according to female standards")
plt.scatter(masculine[male], feminine[male], label="male fictional characters")
plt.scatter(masculine[~male], feminine[~male], label="female fictional characters")
plt.legend()
